    ...
    fn scheme_of(&self, id: String) -> Option<Scheme> {
        match id.as_str() {
            ...
            "may-widgets:Button" => Some(Scheme::new(IndexMap::from(
                [
                    ("background".to_string(), SchemeValue::Paint(Paint::color(Color::rgb(200, 200, 250)))),
                    ("background_hover".to_string(), SchemeValue::Paint(Paint::color(Color::rgb(220, 220, 250)))),
                    ("background_pressed".to_string(), SchemeValue::Paint(Paint::color(Color::rgb(190, 190, 250)))),
                ]
            ))),
            _ => None,
        }
