...
**This folder contains the free `Noto Sans` font which is used as a default font, if the
default `include-noto-sans` feature is enabled inside the `maycoon` crate.**

## Original `README.txt` from Google Fonts:
